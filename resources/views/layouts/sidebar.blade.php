...
<li class="nav-item">
                                <a href="#" class="nav-link nav-toggle" style="color: #b4bcc8;">
                                    <i class="fa fa-money"></i>
                                    <span class="title">Sales Portal</span>
                                </a>
                
                <ul class="sub-menu">
                <li class="nav-item">
                                        <a href="salesportal.php" class="nav-link step" style="color: #b4bcc8;"><i class="icon-users"></i>
                                            <span class="title"> Sales Portal</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a data-toggle="tab" href="#tab0" aria-expanded="false" class="nav-link step"><i class="icon-users"></i>
                                            <span class="title"> Customer's Status</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a data-toggle="tab" href="#tab1" aria-expanded="true" class="nav-link step">
                                            <i class="icon-users"></i><span class="title"> Customer's Information </span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a data-toggle="tab" href="#tab2" aria-expanded="true" class="nav-link step">
                                            <i class="icon-users"></i><span class="title"> Customer Profile </span>
                                        </a>
                                    </li>
                  </ul>
                            ...
                            <li class="nav-item">
                                <a href="credit-req-property-info.php" class="nav-link nav-toggle" style="color:#b4bcc8;">
                                    <i class="icon-home"></i>
                              ...
                              <li class="nav-item active">
                                        <a href="credit-req-property-info.php" style="color:darkblue;">
                                         <i class="fa fa-hourglass-o"></i>   <span class="title">Credit req & Property Info</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="borrower-entity-info.php" class="nav-link " style="color:#b4bcc8;">
                                         <i class="fa fa-hourglass-1"></i>   <span class="title">Borrower & Entity info</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="employment-of-Borrower-co-Borrower.php" class="nav-link " style="color:#b4bcc8;">
                                         <i class="fa fa-hourglass-2"></i>   <span class="title">Employment of Borrower/co-Borrower</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="schedule-of-real-state-and-details.php" class="nav-link" style="color:#b4bcc8;">
                                         <i class="fa fa-hourglass-3"></i>   <span class="title">Schedule of Real State and Details</span>
                                        </a>
                                    </li>
                  
                   <li class="nav-item">
                                        <a href="declarations-and-acknowledgement.php" class="nav-link ">
                                         <i class="fa fa-hourglass"></i>   <span class="title">Declarations and Acknowledgement</span>
                                        </a>
                                    </li>
                  
              
<li class="nav-item" >
                                <a href="javascript:;" class="nav-link nav-toggle" style="color: #b4bcc8;">
                                    <i class="fa fa-industry"></i>
                                    <span class="title">Underwriting Tool</span>
                                </a>
                            </li>
<li class="nav-item">
                                <a href="javascript:;" class="nav-link nav-toggle" style="color: #b4bcc8;">
