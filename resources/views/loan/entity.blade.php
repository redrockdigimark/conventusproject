        ...
        <div class="col-md-12"> <br>
          <div class="portlet light bordered col-md-12" id="form_wizard_1">
            <div class="portlet-title">
              <div class="actions">
			  <a class="btn btn-sm btn-success text-right" href="borroweremployment.php">Save & Continue <i class="fa fa-arrow-right"></i></a> <a class="btn btn-sm btn-success text-right" href="#"> Save & Exit <i class="fa fa-arrow-right"></i></a>
			  </div>
            </div>
...
aria-valuenow="38" aria-valuemin="38" aria-valuemax="100" style="width:38% !important; min-width:38% !important" 
id="progress-1">38%</div>
</div>
 <div class="col-md-12  form-group">
 <h3 class="block text-center" style="display:none;">Entity Information</h3></div>
                                                            
                                                             <div class="col-md-12  form-group">
                                                       
<div class="col-md-3">
                                                                <label class="control-label">Entity Name: 
                                                                </label>      </div>
                                                                <div class="col-md-3">
                                                                    <input class="form-control input-medium" name="entityname" id="entityname" type="text"> 
                                                                     
                                                                </div>
                                                                
                                                      <div class="col-md-3">
                                                                <label class="control-label">Incorporated as: 
                                                                </label>      </div>
                  
				  <input class="form-control input-medium" name="Incorporated" id="Incorporated" type="text">
...
<div class="col-md-3">
                                                                <label class="control-label">State  of Incorporation 
                                                                </label>      </div>
                                                                <div class="col-md-3">
                                                                    <input class="form-control input-medium" name="stateofincor" id="stateofincor" type="text"> 
                                                                     
                                                                </div>
                                                                <div class="col-md-3">
                                                                <label class="control-label">Date of filing to organize 
                                                                </label>      </div>
                                                                <div class="col-md-3 padding-left-0">
                                                                    <input class="form-control input-medium" name="filingdate" id="filingdate" type="date"> 
...
<div class="col-md-12  form-group">
<div class="col-md-3">
                                                                <label class="control-label">Number of members 
                                                                </label>      </div>
                                          <div class="col-md-3 div-menbers"> 
                     <input name="numberOfmembers" class="form-control input-medium" type="text">                                                                                                                                       </div>                            
                                  ...
                                  <div style="float:left; padding-left:15px;">
                                    <label class="control-label">Is business filed in state where loan will be made?</label>
                                  </div>
                  ...
                  <li>
                                      <label>
                                                                            <input name="stateloan" class="stateloan" value="yes" data-title="1" type="radio"> Yes </label>
                                      </li><li><label>
                                                                            <input name="stateloan" class="stateloan" value="no" data-title="2" type="radio"> No </label>
                                      </li></ul>
                                    </div>
                                  </div>
<div class="col-md-12"><hr /></div>
<div class="col-md-12 form-group div-entitymembers">
<div class="col-md-12 padding-0">
<strong class="block text-left"><u>Entity Members<br/></u><br/></strong></div>
<div class="clearfix"></div>
<div class="col-md-3">
                                                                <label class="control-label"> Name 
                                                                </label>      </div>
                                                                <div class="col-md-3">
                                                                    <input class="form-control input-medium" name="membername" id="membername" type="text"> 
                  ...
                  <li>
                                      <label>
                                                                            <input name="signingauthority" class="signingauthority" value="yes" data-title="1" type="radio"> Yes </label>
                                      </li><li><label>
                                                                            <input name="signingauthority" class="signingauthority" value="no" data-title="2" type="radio"> No </label>
                                      </li></ul>
                                    </div>        
...
<div class="col-md-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input class="form-control input-medium" name="membertitle" id="membertitle" type="text"> 
                                                                     
                                                                </div>
                                                                <div class="col-md-6">
<label class="control-label"><em style="font-size: 12px; position: relative; bottom: 5px;"> * Any member with signing authority must be a borrower on the loan application </em></label>
                                                                </div>
                                                                </div>
...
<div class="col-md-12 padding-0">
<hr class="col-md-12" />
<strong class="block text-left"><u>Principal Place of Business<br /></u><br /></strong></div><br class="clearfix" />
<div class="clearfix"></div>
                              <div class="col-md-3">
                                <label  class="control-label">Street Address</label>
                              </div>
                              <div class="col-md-3">
                                <textarea name="streetaddress" id="streetaddress" class="form-control input-medium" rows="3"></textarea>
                              </div>
                            <div class="col-md-6">  
							 <div class="form-group"> 
							  <div class="col-md-6 ">
                              <label class="control-label" style="text-align:left;">Suite</label>
                            </div>
                            <div class="col-md-6">
    ...
    <option value="vermont">Vermont</option>
     ...
     <option value="wyoming">Wyoming</option>
					  ...
					  <div class="col-md-3">
                                  ...
                                  <em style="font-size: 12px; bottom: 5px;">* cannot be post office box</em>
...
<div class="pull-right">			  
			  <a class="btn btn-sm btn-success text-right" href="borroweremployment.php">Save & Continue <i class="fa fa-arrow-right"></i></a> <a class="btn btn-sm btn-success text-right" href="#"> Save & Exit <i class="fa fa-arrow-right"></i></a>   </div>         
			</div>			  
